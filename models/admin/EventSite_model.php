...
class EventSite_model extends CI_Model {
	...
	public function getDatadByEventId($event_id = 0, $data = []) {
		$this->db->select('event_site.site_id, event_site.event_id, site.name,site.state_id, site.city_id,site.site_code');
