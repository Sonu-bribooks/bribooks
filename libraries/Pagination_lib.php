...
class Pagination_lib {
	...
	public function result() {
		return [($this->total) ? (($this->page - 1) * $this->limit) + 1 : 0, ((($this->page - 1) * $this->limit) > ($this->total - $this->limit)) ? $this->total : ((($this->page - 1) * $this->limit) + $this->limit), $this->total, ceil($this->total / $this->limit)];
	}
}
