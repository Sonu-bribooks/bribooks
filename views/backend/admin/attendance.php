							...
							<div class="card-body">
								<div class="row">
									<div class="col-lg-12">
										<div
											id="calendar"
											data-event-url="<?php echo site_url('admin/events?class_id=' . $class_id); ?>"
											data-schedule-url="<?php echo site_url('admin/save_attendance'); ?>"
											data-select="false"
...
function renderStudent(data) {
	...
	$.post('<?php echo site_url('admin/get_attendance_students'); ?>', data, function(json) {
