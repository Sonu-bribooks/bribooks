...
$(function() {
    let columns = JSON.parse(atob('<?php echo _render_column([
        'keys' 		=> ['sn', 'id', 'code', 'level', 'category', 'user', 'status', 'date_modified'],
        'actions'	=> [
            [
                'key' 		=> 'edit',
                'url' 		=> 'admin/lr_assessment_code_form/edit/',
            ],
            [
                'key' 		=> 'status',
				'type' 		=> 'status',
                'url' 		=> 'admin/lr_assessment_code/status/',
            ],
            [
                'key' 		=> 'delete',
                'type' 		=> 'confirm',
                'url' 		=> 'admin/lr_assessment_code/delete/',
            ],
        ]
    ]); ?>'));
