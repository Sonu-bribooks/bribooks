						...
						<div class="tab-content b-0 mb-0">
							...
							<div class="tab-pane" id="basic_info">
								<div class="row">
									<div class="col-12">
										...
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="Role"><?php echo _l('Role'); ?> <span class="required">*</span> </label>
											<div class="col-md-9">
												<select name="role_id" id=""  class="form-control select2" data-toggle="select2">
													<option value=""><?php _el('select_role'); ?></option>
													<?php //pr($this->role_model->get_all(),1) ?>
													<?php foreach ($this->role_model->get_all()['rows'] ?? [] as $site) {
														if (($details['role_id'] ?? '') == $site['id']) {
													?>
												...
												<!-- <input type="text" class="form-control" id="Role" name="Role" value="<?php echo $details['last_name'] ?? ''; ?>" > -->
											</div>
										</div>
							...
							<div class="tab-pane" id="login_credentials">
								<div class="row">
									...
									<div class="col-12">
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="pickup_location_id"> <?php echo _l('pickup_location'); ?> <span class="required">*</span> </label>
											<div class="col-md-9">
												<select class="form-control select2" data-toggle="select2" name="pickup_location_id" id="pickup_location_id">
													<option value=""><?php _el('select_pickup_location'); ?></option>
													<?php foreach ($this->pickup_location_model->get_all()['rows'] ?? [] as $pickup_location) {
														if (($details['pickup_location_id'] ?? '') == $pickup_location['id']) {
													?>
