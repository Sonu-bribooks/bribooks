	...
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				...
				<form class="required-form" action="<?php echo $action ?? 'http://localhost/bribooks/admin/students/add'; ?>" enctype="multipart/form-data" method="post">
					<div id="progressbarwizard">
						<ul class="nav nav-pills nav-justified form-wizard-header mb-3">
							...
							<li class="nav-item">
								<a href="#bank_details" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
									<i class="mdi mdi-bank mr-1"></i>
									<span class="d-none d-sm-inline"><?php echo _l('bank_details'); ?></span>
								</a>
							</li>
							<!-- <li class="nav-item">
						...
						<div class="tab-content b-0 mb-0">
							...
							<div class="tab-pane" id="basic_info">
								<div class="row">
									<div class="col-12">
										...
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label"><?php _el('site'); ?><span class="required">*</span></label>
											<div class="col-md-9">
												<select class="form-control select2" data-toggle="select2" data-site="<?=$details['site_id'] ?? ''?>" name="site_id" id="site_id">
													<option value=""><?php _el('select_site'); ?></option>
													<?php if (!empty($details['site_id'])) { ?>
														<option value="<?= $details['site_id'] ?>" selected><?= $details['site_id'] ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
							...
							<div class="tab-pane" id="bank_details">
								<div class="row">
									<div class="col-12">
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="bank_holder_name"> <?php echo _l('bank_holder_name'); ?> </label>
											<div class="col-md-9">
												<input type="text" id="bank_holder_name" name="bank_holder_name" class="form-control" value="<?php echo $bank_details['name'] ?? ''; ?>">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="bank_name"> <?php echo _l('bank_name'); ?> </label>
											<div class="col-md-9">
												<input type="text" id="bank_name" name="bank_name" class="form-control" value="<?php echo $bank_details['bank_name'] ?? ''; ?>">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="bank_branch_name"> <?php echo _l('bank_branch_name'); ?> </label>
											<div class="col-md-9">
												<input type="text" id="bank_branch_name" name="bank_branch_name" class="form-control" value="<?php echo $bank_details['branch_name'] ?? ''; ?>">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="bank_account_number"> <?php echo _l('bank_account_number'); ?> </label>
											<div class="col-md-9">
												<input type="text" id="bank_account_number" name="bank_account_number" class="form-control" value="<?php echo $bank_details['account_number'] ?? ''; ?>">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="bank_ifsc_code"> <?php echo 'Bank IFSC Code'; ?> </label>
											<div class="col-md-9">
												<input type="text" id="bank_ifsc_code" name="bank_ifsc_code" class="form-control" value="<?php echo $bank_details['ifsc_code'] ?? ''; ?>">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="bank_deleted"> <?php echo _l('bank_status'); ?> </label>
											<div class="col-md-9">
												<select class="form-control select2" data-toggle="select2" name="bank_deleted" id="bank_deleted">
													<option value=""><?php _el('select_bank_status'); ?></option>
													<option <?php echo (!empty($bank_details['status']) && $bank_details['status'] == 1) ? 'selected' : ''; ?> value="0">Active</option>
													<option <?php echo (!empty($bank_details['_deleted']) && $bank_details['_deleted'] == 1) ? 'selected' : ''; ?> value="1">Deleted</option>
												</select>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-12">
										<div class="text-center">
											...
											<div class="mb-3">
												<button type="submit" class="btn btn-primary" name="button"><?php echo _l('submit'); ?></button>
											</div>
										</div>
									</div>
								</div>
