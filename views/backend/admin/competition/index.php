		...
		<div class="card">
			<div class="card-body">
				<h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
					<a href="<?php echo site_url('admin/add_competition'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i> Add New</a>
				</h4>
			</div>
		</div>
	</div>
	...
	$(function() {
		let columns = JSON.parse(atob('<?php echo _render_column([
											...
											'actions'	=> [
												[
													'key' 		=> 'edit',
													'url' 		=> 'admin/add_competition/',
												],
												[
													'key' 		=> 'status',
													'type' 		=> 'status',
													'url' 		=> 'admin/delete_competition/',
												],
											]
										]); ?>'));
