...
<head>
	...
	right: 1.563pt; */
		...
		.backcover .version {
			...
			display: block;
			font-size: <?= 0.5 * 16 * 0.75 * $multiplier ?>pt;
			margin-right: <?=$book_original_info['isbn'] ? 50 : 20?>pt;;
			margin-top: 2pt;
		}
		#book-front-cover {
			position: absolute;
							...
							<div class="isbn-code">
								<div class="isbn-data">
									...
									<p class="text-center" style="font-size: <?= 0.7 * $multiplier * 16 * 0.75 ?>pt;">
										<?= $book_original_info['isbn'] ? $book_original_info['isbn'] : '' ?>
									</p>
								</div>
