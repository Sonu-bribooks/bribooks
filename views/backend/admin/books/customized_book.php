	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url('admin/add_custom_theme_book_comment'); ?>" method="post" id="form-hold-order">
					...
					<div class="form-group">
						...
						<select class="form-control select2" data-toggle="select2" name="comment" id="comment" required>
...
$(function() {
	...
	$(document).on('click', '.reject_book', function(event) {
