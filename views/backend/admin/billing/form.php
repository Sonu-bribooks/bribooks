<?php
	$detail = $this->db->get_where('users', array('id' => $telecaller_id))->row_array();
	$social_links = json_decode($detail['social_links'], true);
?>
<div class="row ">
	<div class="col-xl-12">
		<div class="card">
	...
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				...
				<h4 class="header-title mb-3"><?php echo _l('telecaller_edit_form'); ?></h4>
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo $detail['first_name']; ?>" required>
											</div>
										</div>
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="last_name"><?php echo _l('last_name'); ?> <span class="required">*</span> </label>
											<div class="col-md-9">
												<input type="text" class="form-control" id="last_name" name="last_name" value="<?php echo $detail['last_name']; ?>" required>
											</div>
										</div>
										...
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<textarea name="biography" id = "summernote-basic" class="form-control"><?php echo $detail['biography']; ?></textarea>
											</div>
										</div>
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="telecaller_image"><?php echo _l('telecaller_image'); ?></label>
											<div class="col-md-9">
												<div class="d-flex">
												  <div class="">
													  <img class = "rounded-circle img-thumbnail" src="<?php echo $this->user_model->get_user_image_url($detail['id']);?>" alt="" style="height: 50px; width: 50px;">
												  </div>
												  <div class="flex-grow-1 mt-1 pl-3">
													  <div class="input-group">
														  <div class="custom-file">
															  <input type="file" class="custom-file-input" name = "telecaller_image" id="telecaller_image" onchange="changeTitleOfImageUploader(this)" accept="image/*">
															  <label class="custom-file-label ellipsis" for="telecaller_image"><?php echo _l('choose_telecaller_image'); ?></label>
														  </div>
													  </div>
												  </div>
											  </div>
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="email" id="email" name="email" class="form-control" value="<?php echo $detail['email']; ?>" required>
											</div>
										</div>
									</div>
									...
									<div class="col-12">
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="password" id="password" name="password" class="form-control" <?php echo $telecaller_id ? '' : 'required'; ?> />
											</div>
										</div>
									</div>
									...
									<div class="col-12">
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="tel" id="mobile" name="mobile" class="form-control" value="<?php echo $detail['mobile']; ?>" required>
											</div>
										</div>
									</div>
								</div>
