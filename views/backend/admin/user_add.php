	...
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				...
				<h4 class="header-title mb-3"><?php echo _l('student_add_form'); ?></h4>
										...
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<select class="form-control select2" data-toggle="select2" name="gender" id="gender">
													<option value="M" selected><?php echo _l('male'); ?></option>
													<option value="F"><?php echo _l('female'); ?></option>
												</select>
											</div>
										</div>
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<div class="input-group">
													<div class="custom-file">
														...
														<label class="custom-file-label" for="user_image"><?php echo _l('choose_user_image'); ?></label>
													</div>
												</div>
											</div>
										</div>
