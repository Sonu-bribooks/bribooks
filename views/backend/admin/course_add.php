									...
									<div class="tab-pane" id="basic">
										<div class="row justify-content-center">
											...
											<div class="form-group row mb-3">
												...
												<div class="col-md-10">
													<div class="bg-light p-3" style="height: 150px; overflow: auto;">
														<select name="site[]" class="form-control select2" data-toggle="select2" data-site="<?=$site_id?>" id="filter_site_id" multiple>
														</select>
													</div>
													<a href="javascript:void(0)" onclick="$(this).parent().find('input').trigger('click')"><?php _el('select_all/unselect_all'); ?></a>
												</div>
											</div>
												...
												<!-- 	<div class="form-group row mb-3">
													...
													<div class="form-group row mb-3">
														...
														<div class="col-md-10">
															<div class="row">
																<div class="col-sm-4">
																	<input type="number" class="form-control" id="emi" name="emi[base_online_yearly]" min="0" placeholder="<?php echo _l('enter_quarterly_emi'); ?>" value="<?php echo $course_details['emi']['base_online_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[base_online_half_yearly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['base_online_half_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_half_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[base_online_quarterly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['base_online_quarterly'] ?? 0; ?>" ><span><?php echo _l('enter_quarterly_emi'); ?></span>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="form-group row mb-3">
														...
														<div class="col-md-10">
															<div class="row">
																<div class="col-sm-4">
																	<input type="number" class="form-control" id="emi" name="emi[base_offline_yearly]" min="0" placeholder="<?php echo _l('enter_quarterly_emi'); ?>" value="<?php echo $course_details['emi']['base_offline_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[base_offline_half_yearly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['base_offline_half_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_half_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[base_offline_quarterly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['base_offline_quarterly'] ?? 0; ?>" ><span><?php echo _l('enter_quarterly_emi'); ?></span>
																</div>
															</div>
														</div>
													</div>
												  ...
												  <div class="tab-pane" id="intermediate">
													...
													<div class="form-group row mb-3">
														...
														<div class="col-md-10">
															<div class="row">
																<div class="col-sm-4">
																	<input type="number" class="form-control" id="emi" name="emi[intermediate_online_yearly]" min="0" placeholder="<?php echo _l('enter_quarterly_emi'); ?>" value="<?php echo $course_details['emi']['intermediate_online_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[intermediate_online_half_yearly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['intermediate_online_half_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_half_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[intermediate_online_quarterly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['intermediate_online_quarterly'] ?? 0; ?>" ><span><?php echo _l('enter_quarterly_emi'); ?></span>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="form-group row mb-3">
														...
														<div class="col-md-10">
															<div class="row">
																<div class="col-sm-4">
																	<input type="number" class="form-control" id="emi" name="emi[intermediate_offline_yearly]" min="0" placeholder="<?php echo _l('enter_quarterly_emi'); ?>" value="<?php echo $course_details['emi']['intermediate_offline_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[intermediate_offline_half_yearly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['intermediate_offline_half_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_half_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[intermediate_offline_quarterly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['intermediate_offline_quarterly'] ?? 0; ?>" ><span><?php echo _l('enter_quarterly_emi'); ?></span>
																</div>
															</div>
														</div>
													</div>
...
<!--
													...
													<div class="form-group row mb-3">
														...
														<div class="col-md-10">
															<div class="row">
																<div class="col-sm-4">
																	<input type="number" class="form-control" id="emi" name="emi[advanced_online_yearly]" min="0" placeholder="<?php echo _l('enter_quarterly_emi'); ?>" value="<?php echo $course_details['emi']['advanced_online_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[advanced_online_half_yearly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['advanced_online_half_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_half_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[advanced_online_quarterly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['advanced_online_quarterly'] ?? 0; ?>" ><span><?php echo _l('enter_quarterly_emi'); ?></span>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="form-group row mb-3">
														...
														<div class="col-md-10">
															<div class="row">
																<div class="col-sm-4">
																	<input type="number" class="form-control" id="emi" name="emi[advanced_offline_yearly]" min="0" placeholder="<?php echo _l('enter_quarterly_emi'); ?>" value="<?php echo $course_details['emi']['advanced_offline_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[advanced_offline_half_yearly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['advanced_offline_half_yearly'] ?? 0; ?>" ><span><?php echo _l('enter_half_yearly_emi'); ?></span>
																</div>
																<div class="col-sm-4">
																	<input type="number" class="form-control" name="emi[advanced_offline_quarterly]" min="0" placeholder="<?php echo _l('enter_half_yearly_emi'); ?>" value="<?php echo $course_details['emi']['advanced_offline_quarterly'] ?? 0; ?>" ><span><?php echo _l('enter_quarterly_emi'); ?></span>
																</div>
															</div>
														</div>
													</div>
