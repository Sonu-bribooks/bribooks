<?php
	$detail = $this->db->get_where('users', array('id' => $cluster_admin_id))->row_array();
	...
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				...
				<h4 class="header-title mb-3"><?php echo _l('cluster_admin_form'); ?></h4>
							...
							<div class="tab-pane" id="basic_info">
								<div class="row">
									<div class="col-12">
										...
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="cluster_admin_image"><?php echo _l('cluster_admin_image'); ?></label>
											<div class="col-md-9">
												<div class="d-flex">
												  <div class="">
													  <img class = "rounded-circle img-thumbnail" src="<?php echo $this->cluster_admin_model->get_image_url($details['id'] ?? '');?>" alt="" style="height: 50px; width: 50px;">
												  </div>
												  <div class="flex-grow-1 mt-1 pl-3">
													  <div class="input-group">
														  <div class="custom-file">
															  <input type="file" class="custom-file-input" name="cluster_admin_image" id="cluster_admin_image" onchange="changeTitleOfImageUploader(this)" accept="image/*">
															  <label class="custom-file-label ellipsis" for="cluster_admin_image"><?php echo _l('choose_cluster_admin_image'); ?></label>
														  </div>
													  </div>
												  </div>
											  </div>
								...
								<div class="row">
									...
									<div class="col-12">
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="password" id="password" name="password" class="form-control" <?php echo $cluster_admin_id ? '' : 'required'; ?> />
											</div>
										</div>
									</div>
