					...
					<div class="back-footer">
						...
						<div class="isbn-info">
							...
							<div class="isbn-code">
								...
								<div class="isbn-left">
									<p class="version" style="font-size: <?= 0.4 * $multiplier * 16 * 0.75 ?>pt;color:black;">Version <?= $book['version'] ?></p>
									<div class="isbn-data">
										<?=$barcode?>
							...
							<div class="qr-code">
								...
								<p class="version" style="font-size: <?= 0.6 * $multiplier * 16 * 0.75 ?>pt;color:white;">Version <?= $book['version'] ?></p>
							</div>
							<?php } ?>
