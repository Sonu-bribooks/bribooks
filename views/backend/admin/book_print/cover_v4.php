...
<head>
	...
	right: 1.563pt; */
		...
		.isbn-right {
			right: 0;
			padding-top: 10pt;
			padding-bottom: <?=!empty($price) ? 0 : 10 ?>pt;
			padding-right: 5pt;
		}
		.isbn-right img {
			width: 45pt;
						...
						<div class="isbn-info">
							...
							<div class="isbn-code">
								<div class="isbn-right">
									...
									<?php if (!empty($price)) { ?>
									<div class="mrp">
										<div class="price"><?=$this->config->item('site_currency_symbol') ?><?=$price ?></div>
