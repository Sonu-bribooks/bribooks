	...
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				...
				<a href = "<?php echo $action_add; ?>" class="btn btn-outline-primary btn-rounded alignToTitle ml-1"><i class="mdi mdi-plus"></i><?php echo _l('add_event_user'); ?></a>
...
function tableLoad(event_id = 0) {
	var myColumnDefs = [
        ...
        { title: "User Name", data: "user_name", width: "15%"},
