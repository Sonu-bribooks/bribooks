		...
		<div class="card">
			<div class="card-body">
				<div class="col-lg-12">
					...
					<form class="required-form" action="<?php echo site_url('admin/book_email_template/update'); ?>" method="post" enctype="multipart/form-data">
...
<script ttinymcype="text/javascript">
