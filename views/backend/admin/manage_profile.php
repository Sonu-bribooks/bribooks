<div class="row ">
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				<h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo _l('manage_profile'); ?></h4>
			</div> <!-- end card body-->
		</div> <!-- end card -->
	</div><!-- end col-->
</div>
...
<div class="row ">
	<div class="col-xl-7">
		<div class="card">
			<div class="card-body">
				<h4 class="header-title mb-3"><?php echo _l('basic_info'); ?></h4>
				<?php
				...
				<div class="form-group">
					<label><?php echo _l('first_name');?></label>
				...
				<div class="form-group">
					<label><?php echo _l('facebook_link');?></label>
					<input type="text" class="form-control" name="facebook_link" value="<?php echo $social_links['facebook'] ?? ''; ?>" required/>
				</div>
				<div class="form-group">
					<label><?php echo _l('twitter_link');?></label>
					<input type="text" class="form-control" name="twitter_link" value="<?php echo $social_links['twitter'] ?? ''; ?>" required/>
				</div>
				<div class="form-group">
					<label><?php echo _l('linkedin_link');?></label>
					<input type="text" class="form-control" name="linkedin_link" value="<?php echo $social_links['linkedin'] ?? ''; ?>" required/>
				</div>
				<div class="form-group">
					<label><?php echo _l('a_short_title_about_yourself'); ?></label>
					<textarea rows="5" class="form-control" name="title" placeholder="<?php echo _l('a_short_title_about_yourself'); ?>" required><?php echo $row['title']; ?></textarea>
				</div>
				<div class="form-group">
					<label><?php echo _l('biography'); ?></label>
					<textarea rows="5" class="form-control" id="summernote-basic" name="biography" placeholder="<?php echo _l('biography'); ?>" required><?php echo $row['biography']; ?></textarea>
				</div>
				<div class="form-group">
					<label> <?php echo _l('photo'); ?> <small>(<?php echo _l('the_image_size_should_be_any_square_image'); ?>)</small> </label>
						...
						<div class="flex-grow-1 pl-2">
							<div class="input-group">
								<div class="custom-file">
									...
									<label class="custom-file-label ellipsis" for=""><?php echo _l('choose_file'); ?></label>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row justify-content-center">
					<button type="submit" class="btn btn-primary"><?php echo _l('update_profile');?></button>
				</div>
				</form>
				<?php endforeach; ?>
				</form>
