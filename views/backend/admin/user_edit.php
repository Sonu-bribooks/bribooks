<?php
	$user_data = $this->db->get_where('users', array('id' => $student_id))->row_array();
	...
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				...
				<h4 class="header-title mb-3"><?php echo _l('student_edit_form'); ?></h4>

				<form class="required-form" action="<?php echo site_url('admin/users/edit/'.$student_id); ?>" enctype="multipart/form-data" method="post">
								...
								<div class="row">
									<div class="col-12">
										...
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<select class="form-control select2" data-toggle="select2" data-site="<?=$user_data['site_id'] ?? ''?>" name="site_id" id="site_id">
										...
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="gender"><?php echo _l('gender'); ?></label>
											<div class="col-md-9">
												<select class="form-control select2" data-toggle="select2" name="gender" id="gender">
													<option value="M" <?php echo set_select("gender", 'M', (isset($user_data['gender']) && $user_data['gender'] == 'M') ? true : false); ?>><?php echo _l('male'); ?></option>
													<option value="F" <?php echo set_select("gender", 'F', (isset($user_data['gender']) && $user_data['gender'] == 'F') ? true : false); ?>><?php echo _l('female'); ?></option>
												</select>
											</div>
										</div>
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="text" class="form-control" id="grade" name="grade" value="<?php echo $user_data['grade']; ?>" required>
											</div>
										</div>
										<div class="form-group row mb-3">
										...
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="user_image"><?php echo _l('user_image'); ?></label>
											<div class="col-md-9">
												<div class="d-flex">
												  <div class="">
												  ...
												  <div class="flex-grow-1 mt-1 pl-3">
													  <div class="input-group">
														  <div class="custom-file">
															  ...
															  <label class="custom-file-label ellipsis" for="user_image"><?php echo _l('choose_user_image'); ?></label>
														  </div>
													  </div>
												  </div>
											  </div>
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="text" id="mobile" name="mobile" class="form-control" value="<?php echo $user_data['mobile']; ?>" required>
											</div>
										</div>
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="email"> <?php echo _l('email'); ?> </label>
											<div class="col-md-9">
												<input type="email" id="email" name="email" class="form-control" value="<?php echo $user_data['email']; ?>">
											</div>
										</div>
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="password"><?php echo _l('password'); ?></label>
											<div class="col-md-9">
