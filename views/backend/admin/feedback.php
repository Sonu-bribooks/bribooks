$this->user_model->get($1)<style type="text/css">
    .submit
        {
            background:#353B48;
            border-radius: 10px;
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('feedback'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-4"><?php echo get_phrase('teachers'); ?></h4>
                <div class="my-rating-4" data-rating="2.5"></div>
                <h4 class="header-title mb-4"><?php echo get_phrase('curriculum'); ?></h4>
                <h4 class="header-title mb-4"><?php echo get_phrase('ui/ux of lm'); ?></h4>
                <h4 class="header-title mb-4"><?php echo get_phrase('comments'); ?></h4>
                <textarea class="form-control" rows="5"></textarea>
                <button class="btn btn-default btn-lg submit">Submit</button>
