			...
			<div class="card-body">
				<h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
					...
					<button
						...
						data-orderstatus=""
						data-href="<?=base_url('printingPress/bw_reprint_send_bulk_inprint')?>"
					>
					...
					<button
						class="btn btn-primary bulk-send float-right alignToTitle"
						data-orderstatus=""
						data-href="<?=base_url('printingPress/bw_reprint_send_bulk_verify_print')?>"
					>
					...
					<button
						class="btn btn-primary bulk-send float-right alignToTitle"
						data-orderstatus=""
						data-href="<?=base_url('printingPress/bw_reprint_send_bulk_prited')?>"
					>
		...
		if ($status == 1) {
			$actions = [
				[
					...
					'url' => 'printingPress/bw_reprint_send_in_print/'
				],
			];
		} elseif ($status == 2) {
			$actions = [
				[
					...
					'url' => 'printingPress/bw_reprint_send_verify_print/'
				]
			];
		} elseif ($status == 4) {
			$actions = [
				[
					'key' => 'printed',
					'url' => 'printingPress/bw_reprint_send_printed/'
				]
			];
		}
	?>
