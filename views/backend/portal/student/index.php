		...
		<div class="card">
			<div class="card-body">
				<h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
					<a href = "<?php echo site_url('portal/student_form/add'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo _l('add_student'); ?></a>
				</h4>
			</h4>
			</div> <!-- end card body-->
		</div> <!-- end card -->
					...
					<table id="basic-datatable" class="table table-striped table-centered mb-0">
						<thead>
							<tr>
								...
								<th><?php echo _l('book_written'); ?></th>
								<th><?php echo _l('book_published'); ?></th>
						...
						<tbody>
							<?php foreach ($results as $key => $result): ?>
								<tr>
									...
									<td><?php echo $result['first_name'] . ' ' . $result['last_name']; ?>
										<br><small><?php echo _l('mobile') . ': ' . $result['mobile']; ?></small>
										<br><small><?php echo _l('email') .': ' . $result['email']; ?></small>
									</td>
									<td><?php echo $result['parent_name']; ?></td>
									<td><?php echo $result['grade']; ?></td>
									<td><?php echo $result['section']; ?></td>
									<td><?php echo $result['book_written']; ?></td>
									<td><?php echo $result['book_published']; ?></td>
									<td>
										...
										<div class="dropright dropright">
											...
											<ul class="dropdown-menu">
												<li>
													<a
														class="dropdown-item"
														href="<?php echo site_url('portal/student_form/edit/' . $result['id']) ?>"
													><?php echo _l('edit'); ?></a>
												</li>
												<li>
													<a
														class="dropdown-item"
														href="#"
														onclick="confirm_modal('<?php echo site_url('portal/students/status/' . $result['id']); ?>');"
