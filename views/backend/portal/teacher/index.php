		...
		<div class="card">
			<div class="card-body">
				<h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo $page_title; ?>
					<a href="<?php echo site_url('portal/teacher_form/add'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo _l('add_teacher'); ?></a>
			</h4>
			</div> <!-- end card body-->
		</div> <!-- end card -->
	</div><!-- end col-->
						...
						<?php
						 foreach ($results as $key => $result): ?>
							<tr>
								...
								<td>
									<img src="<?php echo $this->teacher_model->get_image_url($result['id']);?>" alt="" height="50" width="50" class="img-fluid rounded-circle img-thumbnail">
								</td>
									...
									<div class="dropright dropright">
										...
										<ul class="dropdown-menu">
											<li>
												<a
													class="dropdown-item"
													href="<?php echo site_url('portal/teacher_form/edit/' . $result['id']) ?>"
												><?php echo _l('edit'); ?></a>
											</li>
											<li>
												<a
													class="dropdown-item"
													href="#"
													onclick="confirm_modal('<?php echo site_url('portal/teachers/status/' . $result['id']); ?>');"
