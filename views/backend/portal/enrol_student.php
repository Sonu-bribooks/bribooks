		...
		<div class="card">
			<div class="card-body">
			  <div class="col-lg-12">
				...
				<form class="required-form" action="<?php echo site_url('portal/enrol_student/enrol'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<a href="<?php echo site_url('portal/student_form/add'); ?>" target="_blank" class="btn btn-outline btn-info"><?php _el('add_student'); ?></a>
					</div>
					...
					<div class="form-group">
						...
						<span class="text-danger"><?php _el('payment_mode_online_under_beta_testing'); ?></span>
					</div>
...
$(function() {
	$('#user_id').select2({
		ajax: {
			url: '<?php echo site_url('portal/getStudents'); ?>',
...
const getClasses = (course_id, mode, center_id) => {
	...
	submitForm('<?php echo site_url('portal/getClasses'); ?>', fd, json => {
		if (json.classes) {
