	...
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				...
				<a href = "<?php echo site_url('portal/class_form/add'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo _l('add_class'); ?></a>
			</h4>
			</div> <!-- end card body-->
		</div> <!-- end card -->
	</div><!-- end col-->
							...
							<tr>
								...
								<td>
									...
									<ul class="dropdown-menu">
										<li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('portal/classes/status/' . $class['id']); ?>');"><?php echo $class['status'] ? _l('mark_inactive') : _l('mark_active'); ?></a></li>
										<li><a class="dropdown-item" href="<?php echo site_url('portal/attendance/' . $class['id']) ?>"><?php echo _l('check_attendance'); ?></a></li>
										<li><a class="dropdown-item" href="<?php echo site_url('portal/schedules/' . $class['id'] . '/class') ?>"><?php echo _l('add/check_schedules'); ?></a></li>
										<li><a class="dropdown-item" href="<?php echo site_url('portal/class_form/edit/' . $class['id']) ?>"><?php echo _l('edit'); ?></a></li>
										<li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('portal/classes/delete/'.$class['id']); ?>');"><?php echo _l('delete'); ?></a></li>
									</ul>
								</div>
								</td>
							</tr>
