...
">
                <p>Dear <?= !empty($data['owner_name']) ? $data['owner_name'] : 'School Leader' ?>, </p>
                ...
                <p>Not every day do we get to make history, yet together we will break a world record and <b><?= $data['name'] ?></b> will become part of the world’s biggest literary event in the history of our planet. </p>
