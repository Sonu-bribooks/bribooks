...
$('#button-search').on('click', function(e) {
	var url = '<?php echo base_url('filemanager'); ?>?directory=<?php echo $directory; ?>';
...
$('#button-upload').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file[]\']').val() != '') {
			...
			$.ajax({
				url: '<?php echo base_url('filemanager'); ?>/upload?directory=<?php echo $directory; ?>',
				type: 'post',
				dataType: 'json',
...
$('#button-folder').popover({
	...
	trigger: 'click',
	sanitize: false,
	container: '#filemanager .modal-body',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: '<?php echo base_url('filemanager'); ?>/folder?directory=<?php echo $directory; ?>',
			type: 'post',
			dataType: 'json',
