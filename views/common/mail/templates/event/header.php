...
<body>
	<div class="container">
		<div class="header">
			<?php
				$header_image = $this->addtemplate_model->get_email_templates_image_url('header_image_' . $site_id);
				$header_image = !empty($header_image) ? $header_image : (($parent_id != $site_id) ? $this->addtemplate_model->get_email_templates_image_url('header_image_' . $parent_id) : '');
