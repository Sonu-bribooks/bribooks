                                ...
                                <li>
                                    <div class="cart-course-wrapper">
                                        ...
                                        <div class="details">
                                            ...
                                            <input type="radio" class="custom-radio" id="online" name="classType" value="online" checked><label for="online" style="line-height:16px;margin-top:25px;">Online</label>&nbsp;&nbsp;&nbsp;<input class="custom-radio" type="radio" id="offline" name="classType" value="offline"><label style="line-height:16px;" for="offline">Offline</label>
                                        </div>
