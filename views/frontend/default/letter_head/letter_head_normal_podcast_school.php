...
<div>
    ...
    <div>Earlier this year, I had the privilege of shooting an episode with <b><?= $head_name; ?></b>, <b><?= $designation; ?></b> for my podcast series, <i>‘Educators of the World’</i>.</div><br>

    <div>During our conversation, <b><?= $head_first_name; ?></b> suggested that we extend an invitation to all schools in the <b><?= $network_name; ?></b> network to participate in the 2024-25 edition of the National Young Authors’ Fair (NYAF) in India.</div><br>
