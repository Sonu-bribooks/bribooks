...
<div>
	...
	<div>Earlier this year, during the shoot of my podcast series, *Educators of the World*, I had a conversation with <b><?= $head_name; ?></b>.<br>
	<?= $head_first_name; ?> suggested that we extend an invitation to all schools in the <b><?= $network_name; ?></b> to participate in the 2024-25 edition of the National Young Authors’ Fair (NYAF) in India.</div><br>

	<div>As the world’s largest book-writing event for school students, NYAF is an invaluable opportunity for the students of <b><?= $school_name; ?></b>. I encourage you to delegate this to a responsible team member who can register your school by simply scanning the QR code below.</div><br>

	<div style="width: 100%; text-align: center;">
		<img src="<?= $qrcode_url; ?>" alt="QR Code" style="height: 170px;">
	</div><br>
