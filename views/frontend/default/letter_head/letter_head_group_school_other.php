...
<div>
    ...
    <div>Earlier this year, during my conversation with Bhavin Shah, the CEO of Education World, I learned that many schools in the <b><?= $parent_school_name ?></b> network have had outstanding participation in previous editions of the National Young Authors’ Fair, including <b><?= $top_school_1 ?></b><b><?= $top_school_2 ?></b>.</div><br>

    <div>Bhavin suggested that we extend an invitation to all schools in the <b><?= $network_name ?></b> network to participate in the 2024-25 edition of the National Young Authors’ Fair (NYAF) in India, including <b><?= $target_school ?></b>.</div><br>
