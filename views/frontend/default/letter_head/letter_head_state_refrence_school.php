...
<div>
	...
	<div>Last month, during a discussion with Bhavin Shah, CEO of Education World, we were thrilled to discover that <b><?= $reference_school ?></b> from <b><?= $state ?></b> consistently ranks among the top 100 schools in the Literary Leadership Awards, part of the National Young Authors’ Fair (NYAF). My team believes that <b><?= $target_school ?></b>, with its commitment to academic excellence, also has the potential to join this prestigious list of India’s top literary leader schools.</div><br>
	...
	<div style="width: 100%; text-align: center;">
		<img src="<?= $qrcode_url; ?>" alt="QR Code" style="height: 140px;">
	</div><br>

	<div>Upon registration, we will provide you with a personalised communication kit to engage teachers, students, and parents. Schools in the US, UK, Singapore, and beyond have integrated NYAF into their English curriculum, leading to remarkable outcomes where every student becomes a published author.</div><br>
