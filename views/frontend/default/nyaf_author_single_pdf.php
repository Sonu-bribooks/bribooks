					...
					<tr style="height: 8rem;">
						...
						<td width="260">
							<div style="text-align: left;">
								<h2 style="text-transform: uppercase; margin: 0; font-weight: bolder; font-size: <?= (mb_strlen($author_name) > 25) ? 15 : 18; ?>px;"><?= $author_name; ?></h2>
								<span style="font-size: 12px; padding-bottom: 20px;">GRADE - <?= $grade . ', ' . strtoupper($section) . ', ' . $book_rank; ?></span><br />
					...
					<tr style="height: 8rem;">
						...
						<td width="260">
							<div style="text-align: left;">
								...
								<span style="text-transform: uppercase; font-size: <?= (mb_strlen($author_name) > 25) ? 15 : 18; ?>px; font-weight: bold;"><?= $author_name; ?></span><br />
								<span style="font-size: 12px;"><?= $book_rank; ?></span>
							</div>
						</td>
						<td width="120">
							<img src="<?= $guest_1_image; ?>" style="height: 90px; width: 90px; max-width: 90px; border-radius: 100%;" />
						</td>
					</tr>
				</tbody>
			</table>
                ...
                <table style="padding-bottom: 20px;" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr style="height: 8rem;">
                            ...
                            <td width="120">
                                <img src="<?= $guest_2_image; ?>" style="height: 90px; width: 90px; max-width: 90px; border-radius: 100%;" />
                            </td>
                        </tr>
                    </tbody>
                </table>
