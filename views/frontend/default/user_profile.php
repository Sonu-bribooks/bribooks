<?php
 ...
 <section class="page-header-area my-course-area">
     <div class="container">
         <div class="row">
             <div class="col">
                 <h1 class="page-title"><?php echo _l('profile'); ?></h1>
				 <br />
                 ...
                 <ul>
                     ...
                     <li class="active"><a href=""><?php echo _l('user_profile'); ?></a></li>
                ...
                <div class="user-dashboard-box">
                    <div class="user-dashboard-sidebar">
                        ...
                        <div class="user-dashboard-menu">
                            <ul>
                                <li class="active"><a href="<?php echo site_url('home/profile/user_profile'); ?>"><?php echo _l('profile'); ?></a></li>
                                <li><a href="<?php echo site_url('home/profile/user_credentials'); ?>"><?php echo _l('account'); ?></a></li>
                                <li><a href="<?php echo site_url('home/profile/user_photo'); ?>"><?php echo _l('photo'); ?></a></li>
                            </ul>
                        </div>
                    </div>
