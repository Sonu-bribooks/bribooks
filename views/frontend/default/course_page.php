                                        ...
                                        <div class="reviewer-details clearfix">
                                            ...
                                            <div class="review-time">
                                                ...
                                                <div class="reviewer-name">
                                                    <?php
                                                    $user_details = $this->user_model->get($rating['user_id']);
                    ...
                    <div class="course-sidebar-text-box">
                        ...
                        <div class="includes">
                            ...
                            <ul>
                                ...
                                <?php if ($this->session->userdata('user_login') == 1): ?>
                                <li><i class="fas fa-mobile-alt"></i><?php echo get_phrase('enrolled_offline'); ?></li>
                                <?php else: ?>
                                <li><i class="fas fa-mobile-alt"></i><?php echo get_phrase('enroll_online_offline'); ?></li>
                                <?php endif; ?>
...
<div class="modal fade" id="StudentPreviewModal" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content course-preview-modal">
            <div class="modal-header">
                <h5 class="modal-title"><span><?php echo get_phrase('course_preview') ?>:</span><?php echo $course_details['title']; ?></h5>
