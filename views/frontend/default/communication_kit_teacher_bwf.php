  ...
  <div class="body">
    ...
    <div class="row">
      <div class="">
          ...
          <p><strong>Participation in this event is entirely FREE for all students.</strong><br />Please encourage all students to register at <a href="{student_url}">{student_url}</a>.</p>
          <div class="text-center">
              <img src="{qrcode_url}" alt="Image" style="width:150px; border: 1px solid black;" />
          </div>
          <p>Let's make our mark in the world of literature together!</p>
          <p>Best regards,</p>
          <p>{school_name}</p>
      </div>
    </div>
