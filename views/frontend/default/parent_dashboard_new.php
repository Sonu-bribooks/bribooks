...
/*        box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;*/
    ...
    .bg-img {
        background-image: url(https://learn.icode.org/assets/frontend/default/img/dashboard_bg.png);
    background-repeat: no-repeat;
...
<section class="my-dashboard-area" style="padding: 10px 0;">
	<div class="container">
		<ul class="purchase-history-list">
			<li class="purchase-history-list-header d-none">
				<div class="row">
			...
			<?php $i = 0; foreach ($enrols as $enrol_i) {
			...
			<li class="mb-2">
				<div class="row">
					<div class="col-sm-10">
						...
						<?php } ?>
                            <h4 class="purchase-history-list-title"> <?php echo _l('courses'); ?> </h4>
                        </div>
                            </div>
                            <div class="col-sm-2 date text-center" id="totalPoints<?php echo $enrol_i['course']; ?>">
								<div class="card">
                                    <h4>0</h4>
                                    <p class="text"><?php echo _l('total_points'); ?></p>
                                </div>
							</div>
                            <div class="col-sm-2 date text-center" id="nationalRanking<?php echo $enrol_i['course']; ?>">
								<div class="card">
                                    <h4>0</h4>
                                    <p class="text"><?php echo _l('national_ranking'); ?></p>
                                </div>
							</div>
                            <div class="col-sm-2 date text-center" id="currentLevel<?php echo $enrol_i['course']; ?>">
								<div class="card">
                                    <h4>0</h4>
                                    <p class="text"><?php echo _l('current_level'); ?></p>
                                </div>
							</div>
                            <div class="col-sm-2 date text-center" id="currentLevel<?php echo $enrol_i['course']; ?>">
								<div class="card">
                                    <?php echo _et($plan); ?>
                                    <p class="text"><?php echo _l('subscription'); ?></p>
                                </div>
							</div>
                            <div class="col-sm-2 text-center" style="padding: 29px 0;">
								<?php if ($amount) { ?>
								<a
					...
					<div class="col-sm-2 purchase-history-detail" style="padding: 29px 0;">
						<div class="row">
