				...
				<div class="user-dashboard-box mt-3">
					<div class="user-dashboard-content w-100 login-form">
						<div class="content-title-box">
							<h1 class="heading"><?php echo _l('login'); ?></h1>
							<h6 class="subheading"><?php echo _l('provide_your_valid_login_credentials'); ?>.</h6>
						</div>
							...
							<div class="basic-group">
								<div style="padding:0 20px;" >
									<div class="alert alert-danger d-none" role="alert">
										...
										<?php echo _li('You haven\'t registered yet! Click '); ?>
										<a href="https://2022.icode.org/lp/student" target="_blank"><?php echo _li('Sign Up'); ?></a>
									</div>
								</div>
								<?php if (0) { ?>
								<div class="justify-content-center d-block text-center">
									<button class="btn btn-link" onclick="$('#school-code-box').toggleClass('d-none');"><?php _el('do_you_have_school_code?'); ?></button>
								</div>
								<div class="form-group d-none" id="school-code-box">
									<label for="school-code"><?php echo _l('school_code'); ?>:</label>
									<input type="school_code" class="form-control" name="school_code" id="school-code" placeholder="<?php echo _l('school_code'); ?>" value="" required>
								</div>
								<?php } ?>
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<div class="input-group-append" id="send-otp-wrapper">
											<button class="btn btn-outline-secondary" type="button" onClick="sendOtp();"><?php _el('send_validation_code'); ?></button>
										</div>
									</div>
								</div>
								...
								<div class="content-update-box">
									...
									<div class="alert alert-primary mt-4" role="alert">
										<i class="fa fa-exclamation-circle"></i> <?php echo _li('Please_check_spam_folder_if_validation_code_is_not_received'); ?>
									</div>
								</div>
							</div>
						</div>
