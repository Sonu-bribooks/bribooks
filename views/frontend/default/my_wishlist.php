        ...
        <div class="row">
            <div class="col">
                ...
                <ul>
                  ...
                  <li class="active"><a href="<?php echo site_url('home/my_wishlist'); ?>"><?php echo _l('wishlists'); ?></a></li>
    ...
    <div class="container">
                ...
                <div class="my-course-search-bar">
                    <form action="">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="<?php echo _l('search_my_courses'); ?>" onkeyup="getMyWishListsBySearchString(this.value)">
        ...
        <div class="row no-gutters" id = "my_wishlists_area">
            <?php foreach ($my_courses as $my_course):
                  $instructor_details = $this->user_model->get($my_course['user_id']);?>
                <div class="col-lg-3">
