...
trait GlobalEventAuthorSignup {
	public function globalEventAuthorSendSignupOtp() {
	...
	public function globalEventAuthorVerifySignupOtp() {
		...
		if (!$this->json) {
			$lead_info = $this->lead_model->get($this->input->post('lid'));
